  ...
  return (
    <section className="timetable" id="plan">
      ...
      <div className="timetable__block">
        ...
        <p className="timetable__text timetable__text_about_rings">Сбор гостей в 15.00</p>
        <p className="timetable__text timetable__text_about_foto">Выездная регистрация<br />в 15.30</p>
        ...
        <p className="timetable__text timetable__text_about_cake">Свадебный торт <br /> 20.30</p>
